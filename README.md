...
jobs:
  nix-ci:
    uses: hermetic-foundation/.github/.github/workflows/nix-ci.yml@main
    with:
...
jobs:
  release-preflight:
    uses: hermetic-foundation/.github/.github/workflows/release.yml@main
    secrets: inherit
```
...
jobs:
  maintenance:
    uses: hermetic-foundation/.github/.github/workflows/maintenance.yml@main
    with:
      check_flake: true
...
jobs:
  docker-ci:
    uses: hermetic-foundation/.github/.github/workflows/docker-ci.yml@main
    with:
